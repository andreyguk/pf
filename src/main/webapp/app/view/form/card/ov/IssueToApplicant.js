...
Ext.define('pf.view.form.card.ov.IssueToApplicant', {
	extend : 'Ext.window.Window',
	alias : 'widget.IssueToApplicant',
	autoScroll : true,
	plain : true,
	modal : true,
	closable : false,
...
var objFuncType = me.objFuncType;
		...
		Ext.apply(me, {
			items : [ {
				...
				buttons : [ {
					xtype : 'button',
					text : loc.btnIssueToApplicant,
					formBind : true,
					itemId : 'btnIssueToApplicant',
					action : 'issueToApplicant',
					cls : 'btnSave',
					iconCls : 'save'
				}, {
					xtype : 'button',
