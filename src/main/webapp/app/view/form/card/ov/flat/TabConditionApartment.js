Ext.define('pf.view.form.card.ov.flat.TabConditionApartment', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.ov.flat.tabConditionApartment',
	...
	initComponent : function() {
		...
		Ext.applyIf(me, {
			items : [ {
				...
				layout : 'anchor',
				anchor : '80%',
				title : 'Стан і оснащення (квартири)',
				items : [ {
					xtype : 'container',
					layout : {
						type : 'hbox',
					...
					items : [ {
						xtype : 'label',
						html : "<span style='color:red;'>Якщо кімнат більше ніж три, то заповнюється інформація тільки для трьох кімнат, які загалом та в цілому характеризують оздобленні всієї квартири<span/>"
					} ]
				}, {
					xtype : 'grid',
					...
					items : [ {
						xtype : 'combobox',
						flex : 1,
						fieldLabel : 'Загальний стан квартири',
