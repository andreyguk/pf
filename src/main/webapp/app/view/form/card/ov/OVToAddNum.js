...
Ext.define('pf.view.form.card.ov.OVToAddNum', {
	extend : 'Ext.form.Panel',
	alias : 'widget.OVToAddNum',
	...
	initComponent : function() {
		...
		var html = "<div style='text-align: left;overflow-y: auto;overflow-x: hidden;' class='CSSTableGenerator' ><table > <tr> <td width='5%'>Код позиції</td><td width='55%' >Показники</td><td width='40%'>Дані</td></tr>";
