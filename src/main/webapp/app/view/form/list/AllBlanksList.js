Ext.define('pf.view.form.list.AllBlanksList', {
	extend : 'Ext.grid.Panel',
	alias : 'widget.allBlanksList',
	itemId : 'gridAllBlanksList',
	// store : 'Paid',
	layout : 'fit',
	columnLines : true,
	plugins : [ {
	...
	initComponent : function() {
		this.store = Ext.create('pf.store.AllBlanks');
		Ext.apply(this, {
			dockedItems : [ {
				xtype : 'pagingtoolbar',
				store : this.store,
