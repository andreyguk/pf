(function() {
	Ext.define('pf.ux.form.field.ClearButton', {
		 ...
		 * 
		 * @param el an element that is checked for support of the "transition"
		...
		addEscListener : function() {
			...
			this.textField.inputEl.on('keydown', function(e) {
				if (e.getKey() == Ext.EventObject.ESC) {
					...
					// 2011-11-30 Ing. Leonardo D'Onofrio leonardo_donofrio at
					// hotmail.com
		...
		/* FIX FOR 4.1 */
		/*
		 * repositionClearButton: function() { var clearButtonEl =
		 * this.clearButtonEl; if (!clearButtonEl) { return; } var
		 * clearButtonPosition =
		 * this.calculateClearButtonPosition(this.textField);
		...
		calculateClearButtonPosition : function(textField) {
			...
			// 2012-03-08 Ing. Leonardo D'Onofrio leonardo_donofrio at
			// hotmail.com
